...
class TestBisection(unittest.TestCase):
    ...
    def test_should_be_below_to_zero(self):
        self.assertEqual(False,self.bisectionObject.belowToZero(7,-5))

    def test_should_calculate_absolute_error(self):
        self.assertEqual(2,self.bisectionObject.getAbsoluteError(4,2))

    def test_should_calculate_percentual_error(self):
        self.assertEqual(50.0,self.bisectionObject.getPercentualError(4,2))
